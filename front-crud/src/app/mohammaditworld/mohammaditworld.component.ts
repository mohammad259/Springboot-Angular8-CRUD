...
@Component({
  selector: 'app-mohammaditworld',
  templateUrl: './mohammaditworld.component.html',
  styleUrls: ['./mohammaditworld.component.scss']
})
export class MohammaditworldComponent implements OnInit {
